    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Have questions about our pastries? Want to place a special order? We'd
          love to hear from you! Reach out through any of the ways below.
        </p>
      </div>
      ...
      <div className="text-center bg-gradient-to-r from-amber-50 to-yellow-50 rounded-2xl p-8 shadow-lg">
        ...
        <p className="text-gray-600 mb-4">
          Whether you're planning a special event or just want to try our
          delicious pastries, we're excited to hear from you.
        </p>
